                     ...
                     ${
                        ...
                        <div class="flex flex-col gap-2">
                           <div class="py-2 flex gap-4 text-sm text-gray-600 dark:text-neutral-500">
                              ...
                              <img src="left-arrow.svg" class="size-4" alt="">
                        ...
                        ` : `
                        <p class="flex gap-4 items-center py-2 text-start text-sm text-gray-600 dark:text-neutral-500"><span>اسم ورقة العمل: ${table.sheetName}</span><img src="left-arrow.svg" class="size-4" alt=""> <span class="text-green-500">لا يوجد أخطاء</span></p>
                        `).join('')
                     }
                  </div>
               </div>
